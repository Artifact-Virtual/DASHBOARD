...
const Hero: React.FC = () => {
  ...
  return (
  <div className="w-full h-full flex items-center justify-center text-center p-6 sm:p-8 bg-arcx-dark relative overflow-hidden pl-0 sm:pl-16 max-w-full overflow-x-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center w-full">
        ...
        <a href="#arcx-about" onClick={scrollToAbout} 
           className="mt-8 sm:mt-12 border border-arcx-orange/50 text-arcx-orange font-light py-2 sm:py-3 px-6 sm:px-10 rounded-sm text-xs sm:text-sm uppercase tracking-[0.2em] hover:bg-arcx-orange/10 hover:shadow-[0_0_15px_rgba(255,69,0,0.5)] transition-all duration-300 w-full max-w-xs">
          Enter the Ecosystem
        </a>
      </div>
    </div>
